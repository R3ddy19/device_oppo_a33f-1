...
#define LOG_TAG "android.hardware.light@2.0-service.a33f"
...
size_t getHWBinderMmapSize() {
    size_t value = 0;
    value = property_get_int32("persist.vendor.a33f.lighthal.hw.binder.size", DEFAULT_LGTHAL_HW_BINDER_SIZE_KB);
